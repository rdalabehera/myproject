...
function deleteStudent(e) {
  return dispatch => {
      dispatch(request());
      var students =  allServices.deleteStudent(e);
      dispatch(success(students));
  };
  function request() 
  { return { type: allConstants.DELETE_PLAYER_REQUEST } }
  function success(students) { return { type: allConstants.DELETE_PLAYER_SUCCESS,students } }
  function failure(error) { return { type: allConstants.DELETE_PLAYER_FAILURE, error } }
}